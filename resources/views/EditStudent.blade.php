    ...
    >
        ...
        >
            ...
            <form class="flex flex-col space-y-6" action="/api/student/{{ $data->id }}" method="POST">
                @method('patch')
                @csrf
                <label for="nama">Nama : </label>
                <input type="text" v-model="state.nama" />
                <label for="nim">Nim : </label>
                <input type="text" v-model="state.nim" />
                <label for="no_hp">No Hp : </label>
                <input type="text" v-model="state.no_hp" />
                <label for="alamat">Alamat : </label>
                <input type="text" v-model="state.alamat" />
