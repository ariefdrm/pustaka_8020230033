        ...
        <div class="w-[50%] rounded-md border bg-white p-5 dark:bg-black">
            ...
            <form @submit="onSubmit" class="flex flex-col space-y-6">
                <div>
                    ...
                    <input type="text" class="w-full rounded-md border px-2 py-1" v-model="form.nama" />
                </div>
                <div>
                    <label for="nim">Nim : </label>
                    <input type="text" class="w-full rounded-md border px-2 py-1" v-model="form.nim" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" class="w-full rounded-md border px-2 py-1" v-model="form.alamat" />
                </div>
